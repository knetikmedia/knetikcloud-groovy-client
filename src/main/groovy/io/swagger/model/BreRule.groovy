...
import io.swagger.model.ActionContextobject;
import io.swagger.model.ArrayList;
import io.swagger.model.PredicateResource;
import java.util.List;
@Canonical
class BreRule {

  /* A list of actions to execute, and the mapping for their parameters, when the rule runs. Minimum 1 */
  List<ActionContextobject> actions = new ArrayList<ActionContextobject>()
