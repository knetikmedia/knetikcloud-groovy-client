...
class MediaVideosApi {
    ...
    def deleteRelationshipUsingDELETE ( Long videoId, Long id, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
...
if (!"null".equals(String.valueOf(order)))
    ...
    def updateRelationshipUsingPUT ( Long videoId, Long relationshipId, String details, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
