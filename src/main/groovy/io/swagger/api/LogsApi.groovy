...
class LogsApi {
    ...
    def getBREEventLogs ( String filterStartDate, String filterEventName, Integer size, Integer page, String order, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
...
if (!"null".equals(String.valueOf(order)))
    ...
    def getUserLogs ( Integer filterUser, String filterActionName, Integer size, Integer page, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
        String resourcePath = "/audit/logs"
