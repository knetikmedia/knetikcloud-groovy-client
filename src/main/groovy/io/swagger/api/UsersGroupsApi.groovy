...
if (!"null".equals(String.valueOf(order)))
    ...
    def updateGroups ( String filterName, String filterUniqueName, String filterParent, Integer size, Integer page, String order, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
        String resourcePath = "/users/groups"
