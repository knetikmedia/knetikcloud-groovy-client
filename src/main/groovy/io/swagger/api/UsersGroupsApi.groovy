...
import io.swagger.model.PageGroupMemberResource
import io.swagger.model.PageGroupResource
...
class UsersGroupsApi {
    ...
    def deleteGroupUsingDELETE ( String uniqueName, Integer userId, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
    ...
    def deleteGroupUsingDELETE1 ( String uniqueName, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
