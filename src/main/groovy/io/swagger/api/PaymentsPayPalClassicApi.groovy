...
class PaymentsPayPalClassicApi {
    ...
    def createBillingAgreementUrlUsingPOST ( CreateBillingAgreementRequest request, Closure onSuccess, Closure onFailure)  {
    ...
    def expressCheckoutUsingPOST ( CreatePayPalPaymentRequest request, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
    ...
    def finalizeBillingAgreementUsingPOST ( FinalizeBillingAgreementRequest request, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
    ...
    def finalizeCheckoutUsingPOST ( FinalizePayPalPaymentRequest request, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
