...
import io.swagger.model.PageAggregateInvoiceReportResource
...
class ReportingOrdersApi {
    ...
    def getDailyInvoicesUsingGET ( String currencyCode, String granularity, String filterPaymentStatus, String filterFulfillmentStatus, Long startDate, Long endDate, Closure onSuccess, Closure onFailure)  {
...
if (!"null".equals(String.valueOf(endDate)))
        ...
        invokeApi(onSuccess, onFailure, basePath, versionPath, resourcePath, queryParams, headerParams,
                    "GET", "",
                    PageAggregateInvoiceReportResource.class )
