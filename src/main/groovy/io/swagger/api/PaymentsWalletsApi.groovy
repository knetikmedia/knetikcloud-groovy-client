...
if (!"null".equals(String.valueOf(order)))
    ...
    def getWalletTransactions ( Integer filterInvoice, String filterType, Long filterMaxDate, Long filterMinDate, String filterSign, Integer filterUserId, String filterUsername, String filterDetails, String filterCurrencyCode, Integer size, Integer page, String order, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
