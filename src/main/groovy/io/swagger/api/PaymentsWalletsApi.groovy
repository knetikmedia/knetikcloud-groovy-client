...
import io.swagger.model.PageSimpleWallet
import io.swagger.model.PageWalletTotalResponse
import io.swagger.model.PageWalletTransactionResource
...
if (!"null".equals(String.valueOf(order)))
        ...
        invokeApi(onSuccess, onFailure, basePath, versionPath, resourcePath, queryParams, headerParams,
                    "GET", "",
                    PageWalletTransactionResource.class )
