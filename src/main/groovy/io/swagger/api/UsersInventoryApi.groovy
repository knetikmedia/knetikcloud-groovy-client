...
class UsersInventoryApi {
    ...
    def createEntitlementItem ( EntitlementItem entitlementItem, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
...
if (!"null".equals(String.valueOf(order)))
    ...
    def getUserInventory1 ( Integer id, Boolean inactive, Integer size, Integer page, String filterItemName, Long filterMinDate, Long filterMaxDate, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
        String resourcePath = "/users/{id}/inventory"
...
if (!"null".equals(String.valueOf(page)))
    ...
    def getUserInventoryLog1 ( Integer userId, Integer id, Long timestamp, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
    ...
    def getUsersInventory ( Boolean inactive, Integer size, Integer page, String filterItemName, String filterUsername, String filterGroup, String filterDate, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
...
if (!"null".equals(String.valueOf(filterDate)))
    ...
    def updateEntitlementItem ( Integer entitlementId, EntitlementItem entitlementItem, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
        String resourcePath = "/entitlements/{entitlement_id}"
