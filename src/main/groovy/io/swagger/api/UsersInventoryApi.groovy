...
if (!"null".equals(String.valueOf(order)))
    ...
    def getUserInventories ( Integer id, Boolean inactive, Integer size, Integer page, String filterItemName, Long filterMinDate, Long filterMaxDate, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
        String resourcePath = "/users/{id}/inventory"
