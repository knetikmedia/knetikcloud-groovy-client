...
if (!"null".equals(String.valueOf(order)))
    ...
    def getChallenges ( Boolean filterActiveCampaign, String filterStartDate, String filterEndDate, Integer size, Integer page, String order, Closure onSuccess, Closure onFailure)  {
        // create path and map path parameters (TODO)
        String resourcePath = "/challenges"
