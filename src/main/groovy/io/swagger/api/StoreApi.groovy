...
class StoreApi {
    ...
    def createStoreItem ( StoreItem storeItem, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
...
if (!"null".equals(String.valueOf(order)))
    ...
    def updateStoreItem ( Integer id, StoreItem storeItem, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
        String resourcePath = "/store/items/{id}"
