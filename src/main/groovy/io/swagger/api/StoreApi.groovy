...
import io.swagger.model.PageStoreItem
...
class StoreApi {
    ...
    def createItemTemplateUsingPOST ( ItemTemplateResource itemTemplateResource, Closure onSuccess, Closure onFailure)  {
...
if (!"null".equals(String.valueOf(order)))
    ...
    def updateItemTemplateUsingPUT ( String id, ItemTemplateResource itemTemplateResource, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
        String resourcePath = "/store/items/templates/{id}"
