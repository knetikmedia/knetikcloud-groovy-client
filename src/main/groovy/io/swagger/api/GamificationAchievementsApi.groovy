...
if (!"null".equals(String.valueOf(order)))
    ...
    def getUserAchievementsProgress ( Integer userId, Boolean filterAchievementDerived, String filterAchievementTagset, String filterAchievementName, Boolean filterAchievementHidden, Integer size, Integer page, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
...
if (!"null".equals(String.valueOf(page)))
    ...
    def getUsersAchievementProgress ( String achievementName, Boolean filterAchievementDerived, String filterAchievementTagset, Boolean filterAchievementHidden, Integer size, Integer page, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
...
if (!"null".equals(String.valueOf(page)))
    ...
    def getUsersAchievementsProgress ( Boolean filterAchievementDerived, String filterAchievementTagset, String filterAchievementName, Boolean filterAchievementHidden, Integer size, Integer page, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
