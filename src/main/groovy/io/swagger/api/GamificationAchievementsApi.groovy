...
import io.swagger.model.PageAchievementDefinitionResource
import io.swagger.model.PageTemplateResource
import io.swagger.model.PageUserAchievementResource
...
if (!"null".equals(String.valueOf(order)))
    ...
    def getAchievementsUsingGET ( String filterTagset, String filterName, Boolean filterHidden, Integer size, Integer page, String order, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
        String resourcePath = "/achievements"
...
if (!"null".equals(String.valueOf(order)))
        ...
        invokeApi(onSuccess, onFailure, basePath, versionPath, resourcePath, queryParams, headerParams,
                    "GET", "",
                    PageAchievementDefinitionResource.class )
                    
    }
    def getAllUserProgressForAchievementUsingGET ( String achievementName, String filterAchievementTagset, Boolean filterAchievementHidden, Integer size, Integer page, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
...
if (!"null".equals(String.valueOf(page)))
        ...
        invokeApi(onSuccess, onFailure, basePath, versionPath, resourcePath, queryParams, headerParams,
                    "GET", "",
                    PageUserAchievementResource.class )
                    
    }
    def getAllUserProgressUsingGET ( String filterAchievementTagset, String filterAchievementName, Boolean filterAchievementHidden, Integer size, Integer page, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
...
if (!"null".equals(String.valueOf(page)))
    ...
    def getUserProgressUsingGET ( Integer userId, String filterAchievementTagset, String filterAchievementName, Boolean filterAchievementHidden, Integer size, Integer page, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
