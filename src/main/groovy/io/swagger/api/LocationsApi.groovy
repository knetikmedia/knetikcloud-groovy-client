...
class LocationsApi {
    ...
    def getCities ( String countryCodeIso3, String stateCode, Closure onSuccess, Closure onFailure)  {
    ...
    def getCountries1 ( Closure onSuccess, Closure onFailure)  {
        // create path and map variables
    ...
    def getCountries2 ( String countryCodeIso3, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
