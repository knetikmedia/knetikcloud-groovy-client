...
class AuthTokensApi {
    ...
    def deleteToken ( String username, String clientId, Closure onSuccess, Closure onFailure)  {
    ...
    def deleteTokens ( String username, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
