...
if (!"null".equals(String.valueOf(page)))
    ...
    def getInvoices ( Integer filterUser, String filterEmail, String filterFulfillmentStatus, String filterPaymentStatus, String filterItemName, String filterCreatedDate, Integer size, Integer page, String order, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
        String resourcePath = "/invoices"
...
if (!"null".equals(String.valueOf(order)))
    ...
    def listFulFillmentStatuses ( Closure onSuccess, Closure onFailure)  {
        // create path and map variables
    ...
    def listPaymentStatuses ( Closure onSuccess, Closure onFailure)  {
        // create path and map variables
