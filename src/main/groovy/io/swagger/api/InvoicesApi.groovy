...
if (!"null".equals(String.valueOf(order)))
    ...
    def getInvoiceUsingGET ( Integer id, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
...
if (!"null".equals(String.valueOf(page)))
    ...
    def setOrderNotesUsingPUT ( Integer id, String orderNotes, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
