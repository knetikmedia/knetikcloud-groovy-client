...
class DispositionsApi {
    ...
    def addDispositionUsingPOST ( DispositionResource disposition, Closure onSuccess, Closure onFailure)  {
    ...
    def deleteDispositionUsingDELETE ( Long id, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
    ...
    def getDispositionCountUsingGET ( String filterContext, String filterOwner, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
...
if (!"null".equals(String.valueOf(filterOwner)))
    ...
    def getDispositionUsingGET ( Long id, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
        String resourcePath = "/dispositions/{id}"
    ...
    def getDispositionsUsingGET ( String filterContext, String filterOwner, Integer size, Integer page, String order, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
        String resourcePath = "/dispositions"
