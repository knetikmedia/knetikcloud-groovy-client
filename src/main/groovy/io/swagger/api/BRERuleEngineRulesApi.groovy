...
import io.swagger.model.PageBreRule
...
class BRERuleEngineRulesApi {
    ...
    def convertExpressionToStringUsingPOST ( Expressionobject expression, Closure onSuccess, Closure onFailure)  {
    ...
    def createRuleUsingPOST ( BreRule breRule, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
    ...
    def deleteRuleUsingDELETE ( String id, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
    ...
    def enableRuleUsingPUT ( String id, BooleanResource enabled, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
    ...
    def getRuleUsingGET ( String id, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
        String resourcePath = "/bre/rules/{id}"
    ...
    def getRulesUsingGET ( String filterName, Boolean filterEnabled, Boolean filterSystem, String filterTrigger, String filterAction, String filterCondition, Integer size, Integer page, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
        String resourcePath = "/bre/rules"
...
if (!"null".equals(String.valueOf(page)))
    ...
    def updateRuleUsingPUT ( String id, BreRule breRule, Closure onSuccess, Closure onFailure)  {
        // create path and map variables
        String resourcePath = "/bre/rules/{id}"
